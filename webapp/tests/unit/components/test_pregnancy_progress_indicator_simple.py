"""
Упрощенные тесты для компонента визуального индикатора прогресса беременности.

Этот модуль содержит основные тесты для проверки корректности отображения
...
class PregnancyProgressIndicatorSimpleTest(TestCase):
    """Упрощенные тесты для компонента визуального индикатора прогресса беременности."""
